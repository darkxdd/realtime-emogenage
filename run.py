...
def generate_frames():
    ...
    while True:
        ...
        for (x, y, w, h) in faces:
            ...
            # Create info panel
            cv2.rectangle(frame, (x, y-40), (x+w, y), (0, 0, 139), -1)
            cv2.rectangle(frame, (x, y+h), (x+w, y+h+70), (0, 0, 139), -1) 
            ...
            cv2.putText(frame, f'Emotion: {label}', (x+10, y-20), cv2.FONT_HERSHEY_TRIPLEX, 0.8, (255, 255, 255), 2) # White text
            ...
            cv2.putText(frame, f'Gender: {gender_label}', (x, y + h + 25), cv2.FONT_HERSHEY_TRIPLEX, 0.7, (255, 255, 255), 2) # White text

            # Age Prediction
            age_predict = age_model.predict(roi_color)
            age = round(age_predict[0, 0])
            age_label_position = (x, y + h + 50)
            cv2.putText(frame, f'Age: {age}', (x, y + h + 50), cv2.FONT_HERSHEY_TRIPLEX, 0.7, (255, 255, 255), 2) # White text
